...
<script type="text/javascript">
    ...
    function grant5s() {
        ...
        finish5Seconds.play();
        if (!granted) {
            var x = setInterval(receivingGrantedSignal, 1);
            setTimeout(function () {
                resetGrantedPane(0);
                clearInterval(x);
            }, 5000);
    ...
    function receivingGrantedSignal() {
       ...
       if($('#referFi1').html() == '1' && $('#referFi2').html() == '0' && $('#referFi3').html() == '0' && $('#referFi4').html() == '0') pointGranting(1);
       if($('#referFi1').html() == '0' && $('#referFi2').html() == '1' && $('#referFi3').html() == '0' && $('#referFi4').html() == '0') pointGranting(2);
       if($('#referFi1').html() == '0' && $('#referFi2').html() == '0' && $('#referFi3').html() == '1' && $('#referFi4').html() == '0') pointGranting(3);
       if($('#referFi1').html() == '0' && $('#referFi2').html() == '0' && $('#referFi3').html() == '0' && $('#referFi4').html() == '1') pointGranting(4);
