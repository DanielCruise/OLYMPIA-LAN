...
<script type="text/javascript">
    ...
    function receivingGrantedSignal() {
        ...
        if($('#granted1').html() == '1' && $('#granted2').html() == '0' && $('#granted3').html() == '0' && $('#granted4').html() == '0') pointGranting(1);
        if($('#granted1').html() == '0' && $('#granted2').html() == '1' && $('#granted3').html() == '0' && $('#granted4').html() == '0') pointGranting(2);
        if($('#granted1').html() == '0' && $('#granted2').html() == '0' && $('#granted3').html() == '1' && $('#granted4').html() == '0') pointGranting(3);
        if($('#granted1').html() == '0' && $('#granted2').html() == '0' && $('#granted3').html() == '0' && $('#granted4').html() == '1') pointGranting(4);
